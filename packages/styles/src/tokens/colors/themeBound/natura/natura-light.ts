...
export const naturaLightColorTokens: IColorThemeTokens = {
  ...
  colorOnBackground: natura.grayscale.colorBrdNatGray,
  colorSurface: natura.primary.colorBrdNatPrimaryWhite,
  colorOnSurface: natura.grayscale.colorBrdNatGray,
  colorHighlight: natura.grayscale.colorBrdBlack,
  colorHighEmphasis: natura.grayscale.colorBrdNatGray,
  colorMediumEmphasis: natura.grayscale.colorBrdNatGray1,
  colorLowEmphasis: natura.grayscale.colorBrdNatGray2,
