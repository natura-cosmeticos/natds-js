...
import Badge, { isBadgeStandard, buildValue } from './Badge'
...
describe('Badge component', () => {
  ...
  describe('Standard variant', () => {
    ...
    it('should display the limit with a plus sign when it is less or equal than the given value.', () => {
  ...
  describe('buildValue', () => {
    it('should only return the value when it is less than the limit', () => {
      expect(buildValue({ value: 99, limit: 100, variant: 'standard' })).toBe(99)
    })
    it('should return the limit with a plus sign when the value is greater or equal than it', () => {
      expect(buildValue({ value: 99, limit: 99, variant: 'standard' })).toBe('99+')
    })
  })
