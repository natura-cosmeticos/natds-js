...
export const Action = ({
  ...
  src,
  alt
}: Pick<TextFieldProps, 'action' | 'iconName' | 'onClick' | 'ariaLabel' | 'src' | 'alt' | 'disabled' | 'readOnly'>): JSX.Element => {
    ...
    <div className={classes.container}>
      ...
      <div className={classes.overlay}>
        <input
          ...
          value={value}
        />
        {action !== 'none' && <Action action={action} iconName={iconName} onClick={onClick} ariaLabel={ariaLabel} src={src} alt={alt} disabled={disabled} readOnly={readOnly} />}
      </div>
