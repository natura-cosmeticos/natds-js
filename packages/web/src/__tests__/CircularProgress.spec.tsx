...
describe('Circular Progress components', () => {
  ...
  describe('rendering thickness', () => {
    test('should match snapshot - with variant static', () => {
      const component = renderer.create(<CircularProgress thickness={3.6} />).toJSON();
