...
describe('Image component', () => {
  ...
  describe('when disableSelection property is explicitly set to true', () => {
    it('should render correctly', () => {
      testRenderer = TestRenderer.create(<Image alt="Image alt text" disableSelection />)
      expect(testRenderer).toMatchSnapshot()
    })
  })
  ...
  describe('when state is true', () => {
    it('should render correctly', () => {
      testRenderer = TestRenderer.create(<Image alt="Image alt text" state />)
      expect(testRenderer).toMatchSnapshot()
    })
  })
  ...
  describe('when radius is true', () => {
    it('should render correctly', () => {
      testRenderer = TestRenderer.create(<Image alt="Image alt text" radius />)
      expect(testRenderer).toMatchSnapshot()
    })
  })
  describe('when error', () => {
