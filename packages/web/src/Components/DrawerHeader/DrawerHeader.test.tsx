...
describe('DrawerHeader component', () => {
  it('should match snapshot - DrawerHeader Avatar Image', () => {
    ...
    const component = TestRenderer.create(<DrawerHeader avatarSrc={children} />)
  ...
  it('should match snapshot - DrawerHeader Avatar Text', () => {
    ...
    const component = TestRenderer.create(<DrawerHeader avatarChildren={children} />)
  ...
  it('should match snapshot - DrawerHeader Title', () => {
    ...
    const component = TestRenderer.create(<DrawerHeader primary={children} />)
  ...
  it('should match snapshot - DrawerHeader Subtitle', () => {
    const children = 'some_title'
    const component = TestRenderer.create(<DrawerHeader secondary={children} />)
  ...
  it('should match snapshot - DrawerHeader Custom children', () => {
    ...
    const component = TestRenderer.create(<DrawerHeader>{children}</DrawerHeader>)
