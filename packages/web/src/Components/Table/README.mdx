...
import { ComponentWithLabel, getDefaultDecorators, getComponentParams } from '../../../.storybook';

import { tableContainerVariant, tableContainerAttribute } from './stories/sections'
...
<Meta component={[Table, TableBody, TableCell, TableContainer, TableHead, TableRow]}
