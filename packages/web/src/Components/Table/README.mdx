...
import { tableContainerVariant, tableContainerAttribute } from './stories/sections.tsx'
...
<Meta component={[Table, TableBody, TableCell, TableContainer, TableHead, TableRow]} decorators={[withJest(), withContainer]} parameters={parameters} title={"Components|Table"} />

# Table

<Preview>
  <Story name="Table variants">
    <ComponentWithLabel componentList={tableContainerVariant} headingText={"Variants"} />
  </Story>
</Preview>
...
<Preview>
  <Story name="Table attributes">
    <ComponentWithLabel componentList={tableContainerAttribute} headingText={"Attributes"} />
  </Story>
</Preview>
