...
<List>
  ...
  <ListItem button>
    <ListItemIcon>
      <Icon name="" size="small" />
    </ListItemIcon>
    <ListItemText primary="Icon with text" />
  </ListItem>
  <Divider />
  <ListItem button>
    <ListItemAvatar>
    ...
    <ListItemText primary="Avatar with text" />
  </ListItem>
  <Divider />
  <ListItem>
    <ListItemAvatar>
      <Avatar color="default" size="small">
        <Icon name="outlined-product-hair" size="tiny" />
      </Avatar>
    </ListItemAvatar>
    <ListItemText primary="Avatar with text and icon" />
    <ListItemSecondaryAction>
