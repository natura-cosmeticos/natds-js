...
# KeyboardDatePicker
Ideal for more distant dates such as birth dates.
...
export const KeyboardDatePickerWrapper = () => {
...
For more advanced usages, check [Material UI KeyboardDatePicker docs](https://material-ui-pickers.dev/api/KeyboardDatePicker)
...
| :-------------------- | :-------------------------------------------------------------------------------------------------------: | :--------------------------------------: | :----------------------------------------------------------------------------------------------------------------------------: |
| onChange \*           |                            (date: DateIOType, value?: string \| null) => void                             |                                          |                                                   Keyboard onChange callback                                                   |
