...
const defaultPropTypeColor: PropTypes.Color = "default";
...
export const Contained = () => <ButtonGroup
...
export const Outlined = () => <ButtonGroup
  color={colors.primary}
...
/**
 * fix(docs): TS2451 - cannot redeclare block-scoped variable 'iconButton'.
 */
// @ts-ignore
export const iconButton = () => <ButtonGroup
  disabled={boolean("disabled", false)}
  color={select("Colors", colors, colors.primary)}
  size={select("Size", sizes, sizes.medium)}>
