...
const SampleGroupButton = (props: IButtonGroupProps) => (
  <ButtonGroup color="primary" variant="contained" size="medium" {...props}>
...
export const colors = { contained, outlined, text };
