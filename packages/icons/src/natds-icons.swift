...
case .filledMediaPause: return "\u{EA14}"
case .filledMediaPlay: return "\u{EA15}"
case .filledMediaStop: return "\u{EA16}"
case .filledNavigationDirectionleft: return "\u{EA17}"
case .filledNavigationDirectionright: return "\u{EA18}"
case .filledNavigationDirectiontbottom: return "\u{EA19}"
case .filledNavigationDirectiontop: return "\u{EA1A}"
case .filledNavigationMenu: return "\u{EA1B}"
case .filledNavigationMore: return "\u{EA1C}"
case .filledProductBrandsproduct: return "\u{EA1D}"
case .filledSocialMyprofile: return "\u{EA1E}"
case .outlinedActionAdd: return "\u{EA1F}"
case .outlinedActionAddproduct: return "\u{EA20}"
case .outlinedActionAttachment: return "\u{EA21}"
case .outlinedActionAutofilter: return "\u{EA22}"
case .outlinedActionCalendar: return "\u{EA23}"
case .outlinedActionCamerachange: return "\u{EA24}"
case .outlinedActionCancel: return "\u{EA25}"
case .outlinedActionChange: return "\u{EA26}"
case .outlinedActionCheck: return "\u{EA27}"
case .outlinedActionClosedbox: return "\u{EA28}"
case .outlinedActionCopy: return "\u{EA29}"
case .outlinedActionCopylink: return "\u{EA2A}"
case .outlinedActionCycle: return "\u{EA2B}"
case .outlinedActionDelete: return "\u{EA2C}"
case .outlinedActionDone: return "\u{EA2D}"
case .outlinedActionDownload: return "\u{EA2E}"
case .outlinedActionEdit: return "\u{EA2F}"
case .outlinedActionFavorite: return "\u{EA30}"
case .outlinedActionFilter: return "\u{EA31}"
case .outlinedActionGridsquare: return "\u{EA32}"
case .outlinedActionHelp: return "\u{EA33}"
case .outlinedActionHistory: return "\u{EA34}"
case .outlinedActionLightoff: return "\u{EA35}"
case .outlinedActionLighton: return "\u{EA36}"
case .outlinedActionLike: return "\u{EA37}"
case .outlinedActionList: return "\u{EA38}"
case .outlinedActionLove: return "\u{EA39}"
case .outlinedActionMic: return "\u{EA3A}"
case .outlinedActionMicrec: return "\u{EA3B}"
case .outlinedActionNewregister: return "\u{EA3C}"
case .outlinedActionNewrequest: return "\u{EA3D}"
case .outlinedActionOrder: return "\u{EA3E}"
case .outlinedActionPhone: return "\u{EA3F}"
case .outlinedActionPrint: return "\u{EA40}"
case .outlinedActionRating: return "\u{EA41}"
case .outlinedActionRecycle: return "\u{EA42}"
case .outlinedActionRequest: return "\u{EA43}"
case .outlinedActionSave: return "\u{EA44}"
case .outlinedActionSchedule: return "\u{EA45}"
case .outlinedActionSearch: return "\u{EA46}"
case .outlinedActionSelectedalllines: return "\u{EA47}"
case .outlinedActionSend: return "\u{EA48}"
case .outlinedActionSettings: return "\u{EA49}"
case .outlinedActionShare: return "\u{EA4A}"
case .outlinedActionShareios: return "\u{EA4B}"
case .outlinedActionSubtract: return "\u{EA4C}"
case .outlinedActionText: return "\u{EA4D}"
case .outlinedActionUpdate: return "\u{EA4E}"
case .outlinedActionUpload: return "\u{EA4F}"
case .outlinedActionVisibility: return "\u{EA50}"
case .outlinedActionVisibilityoff: return "\u{EA51}"
case .outlinedAlertCancel: return "\u{EA52}"
case .outlinedAlertCheck: return "\u{EA53}"
case .outlinedAlertEmpty: return "\u{EA54}"
case .outlinedAlertIndeterminate: return "\u{EA55}"
case .outlinedAlertInfo: return "\u{EA56}"
case .outlinedAlertNotification: return "\u{EA57}"
case .outlinedAlertWarning: return "\u{EA58}"
case .outlinedCommunicationChat: return "\u{EA59}"
case .outlinedCommunicationEmail: return "\u{EA5A}"
case .outlinedCommunicationHelp: return "\u{EA5B}"
case .outlinedCommunicationMessage: return "\u{EA5C}"
case .outlinedCommunicationOccurrence: return "\u{EA5D}"
case .outlinedCommunicationReadEmail: return "\u{EA5E}"
case .outlinedCommunicationSignal: return "\u{EA5F}"
case .outlinedCommunicationSpeaker: return "\u{EA60}"
case .outlinedCommunicationTreatment: return "\u{EA61}"
case .outlinedContentAdddocument: return "\u{EA62}"
case .outlinedContentAgility: return "\u{EA63}"
case .outlinedContentBellringing: return "\u{EA64}"
case .outlinedContentBook: return "\u{EA65}"
case .outlinedContentBrightness: return "\u{EA66}"
case .outlinedContentChangeview: return "\u{EA67}"
case .outlinedContentChannel: return "\u{EA68}"
case .outlinedContentChristmascard: return "\u{EA69}"
case .outlinedContentConsistency: return "\u{EA6A}"
case .outlinedContentDivulgation: return "\u{EA6B}"
case .outlinedContentEducation: return "\u{EA6C}"
case .outlinedContentExchangereports: return "\u{EA6D}"
case .outlinedContentGallery: return "\u{EA6E}"
case .outlinedContentGift: return "\u{EA6F}"
case .outlinedContentGlobal: return "\u{EA70}"
case .outlinedContentHealth: return "\u{EA71}"
case .outlinedContentHealthy: return "\u{EA72}"
case .outlinedContentIndicator: return "\u{EA73}"
case .outlinedContentLock: return "\u{EA74}"
case .outlinedContentMagic: return "\u{EA75}"
case .outlinedContentMedal: return "\u{EA76}"
case .outlinedContentMenu: return "\u{EA77}"
case .outlinedContentMirror: return "\u{EA78}"
case .outlinedContentPlanb: return "\u{EA79}"
case .outlinedContentProdutivity: return "\u{EA7A}"
case .outlinedContentReport: return "\u{EA7B}"
case .outlinedContentStore: return "\u{EA7C}"
case .outlinedContentWellness: return "\u{EA7D}"
case .outlinedContentWifi: return "\u{EA7E}"
case .outlinedDefaultMockup: return "\u{EA7F}"
case .outlinedFinanceBag: return "\u{EA80}"
case .outlinedFinanceBank: return "\u{EA81}"
case .outlinedFinanceCards: return "\u{EA82}"
case .outlinedFinanceCharging: return "\u{EA83}"
case .outlinedFinanceCreditcard: return "\u{EA84}"
case .outlinedFinanceDebit: return "\u{EA85}"
case .outlinedFinanceDiscount: return "\u{EA86}"
case .outlinedFinanceLittlemachine: return "\u{EA87}"
case .outlinedFinanceMoney: return "\u{EA88}"
case .outlinedFinanceMoneypaper: return "\u{EA89}"
case .outlinedFinancePromotion: return "\u{EA8A}"
case .outlinedFinanceShoppingcart: return "\u{EA8B}"
case .outlinedFinanceShoppingcartproduct: return "\u{EA8C}"
case .outlinedFinanceTagdiscount: return "\u{EA8D}"
case .outlinedFinanceTransfermoney: return "\u{EA8E}"
case .outlinedMediaApp: return "\u{EA8F}"
case .outlinedMediaCamera: return "\u{EA90}"
case .outlinedMediaMonitor: return "\u{EA91}"
case .outlinedMediaPlay: return "\u{EA92}"
case .outlinedNavigationArrowbottom: return "\u{EA93}"
case .outlinedNavigationArrowleft: return "\u{EA94}"
case .outlinedNavigationArrowright: return "\u{EA95}"
case .outlinedNavigationArrowtop: return "\u{EA96}"
case .outlinedNavigationClose: return "\u{EA97}"
case .outlinedNavigationDirectionbottom: return "\u{EA98}"
case .outlinedNavigationDirectionleft: return "\u{EA99}"
case .outlinedNavigationDirectionright: return "\u{EA9A}"
case .outlinedNavigationDirectiontop: return "\u{EA9B}"
case .outlinedNavigationExit: return "\u{EA9C}"
case .outlinedNavigationGoback: return "\u{EA9D}"
case .outlinedNavigationGofront: return "\u{EA9E}"
case .outlinedNavigationHome: return "\u{EA9F}"
case .outlinedNavigationMenu: return "\u{EAA0}"
case .outlinedPlaceBus: return "\u{EAA1}"
case .outlinedPlaceForklift: return "\u{EAA2}"
case .outlinedPlaceGps: return "\u{EAA3}"
case .outlinedPlaceLocal: return "\u{EAA4}"
case .outlinedPlaceRocket: return "\u{EAA5}"
case .outlinedPlaceRunningtruck: return "\u{EAA6}"
case .outlinedPlaceTruck: return "\u{EAA7}"
case .outlinedPlaceWaze: return "\u{EAA8}"
case .outlinedProductBagproduct: return "\u{EAA9}"
case .outlinedProductBeard: return "\u{EAAA}"
case .outlinedProductBrandsproduct: return "\u{EAAB}"
case .outlinedProductChildish: return "\u{EAAC}"
case .outlinedProductDailycare: return "\u{EAAD}"
case .outlinedProductHair: return "\u{EAAE}"
case .outlinedProductMakeup: return "\u{EAAF}"
case .outlinedProductOutlet: return "\u{EAB0}"
case .outlinedProductPerfumery: return "\u{EAB1}"
case .outlinedProductPromotionproduct: return "\u{EAB2}"
case .outlinedProductVegan: return "\u{EAB3}"
case .outlinedSocialAddcontact: return "\u{EAB4}"
case .outlinedSocialBirthday: return "\u{EAB5}"
case .outlinedSocialCollaborate: return "\u{EAB6}"
case .outlinedSocialContact: return "\u{EAB7}"
case .outlinedSocialDigitalconsultant: return "\u{EAB8}"
case .outlinedSocialGroupofpeople: return "\u{EAB9}"
case .outlinedSocialMyprofile: return "\u{EABA}"
case .outlinedSocialNetwork: return "\u{EABB}"
case .outlinedSocialPerson: return "\u{EABC}"
